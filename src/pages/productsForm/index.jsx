...
// import { ChevronUpRightIcon } from '@heroicons/react/24/solid';
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* <nav className="bg-gray-100 py-4 px-6 shadow-md sticky top-0 z-50">
        <div className="max-w-8xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold text-black" style={{ fontFamily: "'Poppins', sans-serif" }}>
              Clothes Virtual Try-On
            </h1>
          </div>
          <a
            href="#learn-more"
            className="text-md font-medium text-black hover:underline hover:decoration-black flex items-center"
      ...
      <div className="py-8 px-4 sm:px-8">
        <div>
          <DimensionForm onSubmit={(data) => setDimensions(data)} />
          {dimensions && photo && (
            <div className="mt-6">
